import type { Modifier } from '../models/rules.model';
...
export const RACES: RaceData[] = [
  {
    id: 'human', name: 'Humain', source: 'PHB', speed: 30, size: 'Medium',
    traits: ['Versatile', 'Resourceful'], modifiers: [],
  },
  {
    id: 'elf', name: 'Elfe', source: 'PHB', speed: 30, size: 'Medium', darkvision: 60,
    ...
    subraces: [
      { id: 'high-elf', name: 'Haut Elfe', traits: ['Cantrip', 'Extra Language'], modifiers: [
      ...
      { id: 'wood-elf', name: 'Elfe des bois', traits: ['Fleet of Foot', 'Mask of the Wild'], modifiers: [
      ...
      { id: 'dark-elf', name: 'Drow', traits: ['Superior Darkvision', 'Sunlight Sensitivity', 'Drow Magic'], modifiers: [
  ...
  {
    id: 'dwarf', name: 'Nain', source: 'PHB', speed: 25, size: 'Medium', darkvision: 60,
    ...
    subraces: [
      { id: 'hill-dwarf', name: 'Nain des collines', traits: ['Dwarven Toughness'], modifiers: [
      ...
      { id: 'mountain-dwarf', name: 'Nain des montagnes', traits: ['Dwarven Armor Training'], modifiers: [
  ...
  {
    id: 'halfling', name: 'Halfelin', source: 'PHB', speed: 25, size: 'Small',
    ...
    subraces: [
      { id: 'lightfoot', name: 'Pied-léger', traits: ['Naturally Stealthy'], modifiers: [
      ...
      { id: 'stout', name: 'Robuste', traits: ['Stout Resilience'], modifiers: [
  ...
  {
    id: 'dragonborn', name: 'Drakéide', source: 'PHB', speed: 30, size: 'Medium',
  ...
  {
    id: 'gnome', name: 'Gnome', source: 'PHB', speed: 25, size: 'Small', darkvision: 60,
    ...
    subraces: [
      { id: 'forest-gnome', name: 'Gnome des forêts', traits: ['Natural Illusionist', 'Speak with Small Beasts'], modifiers: [
      ...
      { id: 'rock-gnome', name: 'Gnome des roches', traits: ["Artificer's Lore", 'Tinker'], modifiers: [
  ...
  {
    id: 'half-elf', name: 'Demi-elfe', source: 'PHB', speed: 30, size: 'Medium', darkvision: 60,
  ...
  {
    id: 'half-orc', name: 'Demi-orque', source: 'PHB', speed: 30, size: 'Medium', darkvision: 60,
  ...
  {
    id: 'tiefling', name: 'Tieffelin', source: 'PHB', speed: 30, size: 'Medium', darkvision: 60,
